            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                       <?php   
                                            ...
                                            $rs = $dbh -> query("SELECT * FROM pendaftar WHERE nama_ukm='$userRow[ukmname]'  ");
                                            $count = $rs -> rowCount();
                                            print("$count");
                                        ?> 
                        ...
                        <a href="?go=dashboardukmapendaftar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                            ...
                                            $dbh = Database::getInstance();
                                            $rs = $dbh -> query("SELECT * FROM pendaftar WHERE terima='1' and tolak='0' and nama_ukm='$userRow[ukmname]'  ");
                                            $count = $rs -> rowCount();
                                            print("$count");
                                        ?> 
                                    </div>
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php   
                                            ...
                                            $dbh = Database::getInstance();
                                            $rs = $dbh -> query("SELECT * FROM pendaftar WHERE terima='0' and tolak='1' and nama_ukm='$userRow[ukmname]'  ");
                                            $count = $rs -> rowCount();
                                            print("$count");
                                        ?> 
                                    </div>
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php   
                                            ...
                                            $dbh = Database::getInstance();
                                            $rs = $dbh -> query("SELECT * FROM pendaftar WHERE terima='0' and tolak='0' and nama_ukm='$userRow[ukmname]'  ");
                                            $count = $rs -> rowCount();
                                            print("$count");
                                        ?> 
                                    </div>
