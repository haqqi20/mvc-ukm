            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="?go=dashboardsuperpendaftar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                             <?php   
                                                $dbh = Database::getInstance();
                                                $rs = $dbh -> query("SELECT * FROM pendaftar WHERE terima='1' and tolak='0'  ");
                                                $count = $rs -> rowCount();
                                            print("$count");?> 
                                    </div>
                                    <div>Pendaftar Diterima</div>
                                </div>
                            </div>
                        </div>
                        <a href="?go=dashboardsuperpendaftar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php   
                                                $dbh = Database::getInstance();
                                                $rs = $dbh -> query("SELECT * FROM pendaftar WHERE terima='0' and tolak='1'  ");
                                                $count = $rs -> rowCount();
                                            print("$count");?> 
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php   
                                                $dbh = Database::getInstance();
                                                $rs = $dbh -> query("SELECT * FROM pendaftar WHERE terima='0' and tolak='0'  ");
                                                $count = $rs -> rowCount();
                                            print("$count");?> 
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php   
                                                $dbh = Database::getInstance();
                                                $rs = $dbh -> query("SELECT * FROM ukmdefault  ");
                                                $count = $rs -> rowCount();
                                            print("$count");?> 
                                    </div>
                                    <div>UKM UDINUS</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php   
                                                $dbh = Database::getInstance();
                                                $rs = $dbh -> query("SELECT * FROM ukmdefault WHERE status_terdaftar='1'  ");
                                                $count = $rs -> rowCount();
                                            print("$count");?> 

                                    </div>
                                    <div>UKM Terdaftar</div>
                                </div>
                            </div>
                        </div>
                        <a href="?go=dashboardsuperukm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php   
                                                $dbh = Database::getInstance();
                                                $rs = $dbh -> query("SELECT * FROM ukmdefault WHERE status_terdaftar='0'  ");
                                                $count = $rs -> rowCount();
                                            print("$count");?> 
                                    </div>
                                    <div>Belum Terdaftar</div>
                                </div>
                            </div>
                        </div>
                        <a href="?go=dashboardsuperukm">
